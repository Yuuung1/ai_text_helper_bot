...
/tasks <текст>
```
Команда отправляет текст в Gemini API и возвращает задачи и договоренности из текста.

```bash
/bussines <текст>
```
Команда отправляет текст в Gemini API и возвращает переделанный в деловой стиль текст.
